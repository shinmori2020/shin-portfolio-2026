...
export const skillGroups: SkillGroup[] = [
  {
    icon: "code",
    cat: "Frontend",
    desc: "React / Next.js を中心に扱います。型安全で保守しやすいフロントを設計します。",
    items: ["React / Next.js", "App Router", "TypeScript", "Tailwind CSS", "Framer Motion"],
  },
  {
    icon: "site",
    cat: "WordPress",
    desc: "テーマ開発は制作の現場で培いました。ヘッドレス構成への移行まで対応します。",
    items: ["テーマ開発・保守", "ヘッドレスWP", "カスタムフィールド設計", "既存資産の移行"],
  },
  {
    icon: "support",
    cat: "開発・運用",
    desc: "ホスティングや保守・運用に対応します。業務効率化など周辺領域のご相談にも応じます。",
...
export const values: Value[] = [
  {
    title: "ヒアリングを重視する",
    desc: "つくる前の対話を大切にします。目的や背景を丁寧に伺います。必要なものを見極めてから設計に入ります。",
  },
  {
    title: "速さとレスポンシブを丁寧に",
    desc: "表示速度とどの画面でも崩れない作りに気を配ります。読みやすさと軽さを両立します。端末を問わず快適に見られる状態にします。",
  },
  {
    title: "返答が早い",
    desc: "ご連絡にはできるだけ早くお返しします。やり取りのテンポを保ちます。安心して進められる状態をつくります。",
  },
];
