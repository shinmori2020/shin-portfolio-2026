...
export const skillGroups: SkillGroup[] = [
  {
    icon: "code",
    cat: "Frontend",
    desc: "React / Next.js を中心に型安全で保守しやすいフロントを設計します。",
    items: ["React / Next.js", "App Router", "TypeScript", "Tailwind CSS", "Framer Motion"],
  },
  {
    icon: "site",
    cat: "WordPress",
    desc: "制作現場で培ったテーマ開発からヘッドレス構成への移行まで対応します。",
    items: ["テーマ開発・保守", "ヘッドレスWP", "カスタムフィールド設計", "既存資産の移行"],
  },
  {
    icon: "support",
    cat: "開発・運用",
    desc: "ホスティングや保守・運用から業務効率化まで周辺領域を幅広く支えます。",
...
export const values: Value[] = [
  {
    title: "まずはじっくり伺う",
    desc: "つくる前の対話を何より大切にしています。目的や背景をじっくり伺いながら本当に必要なものを見極めてから設計に入ります。",
  },
  {
    title: "速さと見やすさを両立する",
    desc: "表示速度とどの画面でも崩れない見やすさを大切にしています。読み込みの軽さと読みやすさを両立させてどの端末でも快適に見られるように整えます。",
  },
  {
    title: "お待たせしないやり取り",
    desc: "ご連絡にはできるだけ早くお返しすることを心がけています。やり取りのテンポを保ちながら安心して進めていただける状態をつくります。",
  },
];
