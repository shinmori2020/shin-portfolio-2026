  ...
  return (
    <motion.button
      ...
      className={`
        ...
        rounded-full bg-green-950 text-sm font-medium tracking-wide
        text-stone-50 transition-colors duration-200
        hover:enabled:bg-green-900
...
function Spinner() {
  return (
    <span
      role="status"
      aria-label="送信中"
      className="size-4 animate-spin rounded-full border-2 border-stone-50/30 border-t-stone-50"
    />
  );
}
